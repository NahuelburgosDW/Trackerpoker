...
import {
  computeStats, monthlyProfit, performanceByBuyIn,
  performanceByGameType, positionDistribution, tournamentVolume,
...
export function StatisticsPage() {
  const { tournaments, years } = useAppData();
  const [year, setYear] = useState(String(years[years.length - 1] ?? new Date().getFullYear()));
